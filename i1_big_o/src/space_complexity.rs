/* EXPLANATION:
 * The space Complexity of an algorithm is the total amount
 * of memory space used by the algorithm including the space
 * of its input values for execution.
 */
...
/// The space complexity of this function is linear space
/// -> O(n) space!
